window.onload=function()
{
	...
	for(var loop=0 ; loop < 10 ; loop++)
		document.getElementById("news_").getElementsByClassName("news_2")[0].innerHTML = '<div class="news_2_x"><img src="" alt=""><div><div class="news_title"></div><div class="article"></div></div><div><span class="time"></span><span class="detail"><a href="">&nbsp;&nbsp;<img src="../../../	static/Home/xq.png" alt="">详情</a></span></div><br><br><br><hr><br></div>' + document.getElementById("news_").getElementsByClassName("news_2")[0].innerHTML;
	//GetAllOn();
